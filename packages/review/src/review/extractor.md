...
class LoadBearingResult(BaseModel, frozen=True):
    ...
    classification: Literal[
        "internally_contested", "externally_contested",
        "externally_anchored", "critical_gap", "anchored",
        "depends_on_contested", "peripheral"
    ]
...
class PipelineState(BaseModel):
    ...
    # Step 8 writes (load_bearing_claims mutated in place)
