...
- "runtime" suggests evaluation timing The facility actually describes how the format string is obtained.
...
- The format string is dynamically provided The format string is not a compile-time constant The validation is deferred (but may still occur during constant evaluation)
...
**[P2918]
   Victor Zverovich. [Runtime format strings II](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2023/p2918r2.html). URL: [https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2023/p2918r2.html](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2023/p2918r2.html)
[P3391]
   Barry Revzin. [`constexpr std::format`](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2025/p3391r2.html). URL: [https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2025/p3391r2.html](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2025/p3391r2.html)**
