...
![Figure 1 – Expected memory layout of inheritance-based polymorphism](p0957r8-fig13-1.png)

Figure 1 – Expected memory layout of inheritance-based polymorphism Figure 2 – Expected memory layout of std::proxy Because of pointer semantics, the expected memory layout of `std::proxy` is also different from traditional inheritance. For instance, Figure 1 and Figure 2 shows their expected memory layout, respectively.

![Figure 2 – Expected memory layout of std::proxy](p0957r8-fig13-2.png)

<table border="1" rules="all" cellpadding="6" cellspacing="0" style="border-collapse: collapse; width: 100%;">
<tr>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"></th>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;">The &quot;proxy&quot;</th>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;">Inheritance-based polymorphism</th>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">Abstraction</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">struct Draw : std::dispatch&lt;void()&gt; { 
  template &lt;class T&gt; 
...
struct FDrawable : std::facade&lt;Draw, Area&gt; {};</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">struct IDrawable { 
  virtual void Draw() const = 0; 
  virtual double Area() const = 0; 
  virtual ~IDrawable() {} 
};</pre></td>
...
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">Implementation</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">class Rectangle { 
 public: 
  void Draw() const { 
...
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">class Rectangle : public IDrawable { 
 public: 
  void Draw() const override { 
    printf(&quot;{Rectangle: width = %f, height = %f}&quot;, width_, height_); 
  } 
...
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">Invocation</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">void DoSomethingWithDrawable(std::proxy&lt;FDrawable&gt; p) { 
  p.invoke&lt;op::Draw&gt;(); 
}</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">void DoSomethingWithDrawable(std::unique_ptr&lt;IDrawable&gt; p) { 
  p-&gt;Draw(); 
}</pre></td>
</tr>
</table>
...
<table border="1" rules="all" cellpadding="6" cellspacing="0" style="border-collapse: collapse; width: 100%;">
<tr>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;">RISC-V RV64</th>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;">clang</th>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;">13.0.0</th>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;">-std=c++20 -O3</th>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">To evaluate the quality of code generation, we tried to compile the &quot;Drawable&quot; example from section 3 with various 
compilers and compare the generated assembly between the sample implementation of the &quot;proxy&quot; and traditional 
inheritance-based polymorphism. Specifically, the sample code to compile is listed in Table 2, the sample compiler 
configurations for different processor architectures are listed in Table 3. 
 
 
Library side</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">The &quot;proxy&quot; 
mov     rax, qword ptr [rdi] 
add     rdi, 8 
jmp     qword ptr [rax + 24]</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">Table 3 – Sample compiler configurations</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">Inheritance-based polymorphism 
mov     rdi, qword ptr [rdi] 
mov     rax, qword ptr [rdi] 
jmp     qword ptr [rax]</pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">Client side</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">mov     rax, qword ptr [rdi + 8] 
movsd   xmm0, qword ptr [rax] 
movsd   xmm1, qword ptr [rax + 8] 
mov     edi, offset .L.str.18 
mov     al, 2 
jmp     printf</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">Table 4 – Generated code from clang 13.0.0 (x86-64)</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">movsd   xmm0, qword ptr [rdi + 8] 
...
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">Library side</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">The &quot;proxy&quot; 
ldr     x1, [x0], 8 
ldr     x1, [x1, 24] 
mov     x16, x1 
br      x16</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">Inheritance-based polymorphism 
ldr     x0, [x0] 
ldr     x1, [x0] 
ldr     x1, [x1] 
...
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">Client side</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">mov     x1, x0 
adrp    x0, .LC3 
add     x0, x0, :lo12:.LC3 
ldr     d0, [x1] 
b       printf</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">Table 5 – Generated code from gcc 11.2 (ARM64)</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">mov     x1, x0 
adrp    x2, .LC0 
add     x0, x2, :lo12:.LC0 
ldp     d0, d1, [x1, 8] 
...
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">Client side</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">ld      a0, 8(a0) 
ld      a2, 8(a0) 
ld      a1, 0(a0) 
lui     a0, %hi(.L.str.18) 
...
tail    printf</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 25%;"><pre style="margin: 0;">ld      a2, 16(a0) 
ld      a1, 8(a0) 
lui     a0, %hi(.L.str) 
addi    a0, a0, %lo(.L.str) 
tail    printf</pre></td>
...
As the constraint of the class template, the expression inside `requires` is equivalent to that `F` meets the

`BasicFacade` requirements.
...
<table border="1" rules="all" cellpadding="6" cellspacing="0" style="border-collapse: collapse; width: 100%;">
<tr>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;">Name</th>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;">Value</th>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">template &lt;class P, class... Args&gt; 
HasNothrowPolyConstructor&lt;P, Args...&gt;</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">conditional_t&lt;proxiable&lt;P, F&gt;, 
is_nothrow_constructible&lt;P, Args...&gt;, 
false_type&gt;::value</pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">template &lt;class P, class... Args&gt; 
HasPolyConstructor&lt;P, Args...&gt;</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">conditional_t&lt;proxiable&lt;P, F&gt;, 
...
<table border="1" rules="all" cellpadding="6" cellspacing="0" style="border-collapse: collapse; width: 100%;">
<tr>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;">HasTrivialCopyConstructor</th>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;">F::minimum_copyability ==</th>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">constraint_level::trivial 
HasNothrowCopyConstructor</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">F::minimum_copyability &gt;=</pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">constraint_level::nothrow 
HasCopyConstructor</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">F::minimum_copyability &gt;=</pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">constraint_level::nontrivial 
HasNothrowMoveConstructor</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">F::minimum_relocatability &gt;=</pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">constraint_level::nothrow 
HasMoveConstructor</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">F::minimum_relocatability &gt;=</pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">constraint_level::nontrivial 
HasTrivialDestructor</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">F::minimum_destructibility ==</pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">constraint_level::trivial 
HasNothrowDestructor</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">F::minimum_destructibility &gt;=</pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">constraint_level::nothrow 
HasDestructor</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">F::minimum_destructibility &gt;=</pre></td>
</tr>
</table>
...
template <class P, class... Args> 
                                      HasNothrowPolyConstructor<P, Args...> && 
HasNothrowPolyAssignment 
                                      HasNothrowDestructor 
template <class P, class... Args> 
                                      HasPolyConstructor<P, Args...> && 
HasPolyAssignment 
                                      HasDestructor 
```
...
<table border="1" rules="all" cellpadding="6" cellspacing="0" style="border-collapse: collapse; width: 100%;">
<tr>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;">HasTrivialCopyAssignment</th>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;">HasTrivialCopyConstructor &amp;&amp;</th>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">HasTrivialDestructor 
HasNothrowCopyAssignment</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">HasNothrowCopyConstructor &amp;&amp;</pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">HasNothrowDestructor 
HasCopyAssignment</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">HasNothrowCopyAssignment ||</pre></td>
</tr>
</table>
...
<table border="1" rules="all" cellpadding="6" cellspacing="0" style="border-collapse: collapse; width: 100%;">
<tr>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;">HasNothrowMoveAssignment</th>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;">HasNothrowMoveConstructor &amp;&amp;</th>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">HasNothrowDestructor 
HasMoveAssignment</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;">HasMoveConstructor &amp;&amp; HasDestructor</pre></td>
</tr>
</table>
...
<tr>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"></th>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;">*this contains a value</th>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;">*this does not contain a value</th>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">rhs contains a value</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">Swap the contained values of *this and 
rhs with a temporary storage. If an 
exception is thrown, each of *this and 
rhs is in a valid state with unspecified 
value.</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">Equivalent 
to 
(*this 
= 
std::move(rhs)); post condition is 
that *this contains a value and rhs does 
not contain a value. 
no effect</pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">rhs does not contain 
a value</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">Equivalent 
to 
std::move(*this)); post condition 
is that *this does not contain a value 
and rhs contains a value.</pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 33%;"><pre style="margin: 0;">(rhs 
=</pre></td>
</tr>
</table>
