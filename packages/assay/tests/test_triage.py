...
def _make_chunks(headings: list[str], char_counts: list[int] | None = None) -> list[dict]:
...
class TestProposalDetection:
    ...
    def test_intent_ask_always_analyzes(self):
        ...
        front = {"intent": "ask", "audience": ["LEWG"]}
    ...
    def test_p2900r14_like(self):
        ...
        result = should_analyze(chunks, {"audience": ["CWG", "LWG"]}, "x" * 294_000)
        assert result.analyze is True
        assert result.paper_type == "proposal"
...
class TestStats:
    def test_stats_populated(self):
        ...
        result = should_analyze(chunks, {"audience": ["LEWG"]}, "x" * 10_000)
